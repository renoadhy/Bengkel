...
$routes->post('servis-search', 'Servis::list_servis');
...
$routes->post('servis-detail_penjualan', 'ServisKeluar::detail_penjualan');
$routes->get('servis-nota/(:num)', 'ServisKeluar::cetak_nota/$1');
