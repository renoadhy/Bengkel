...
<section class="content">
        ...
        <div class='col-md-12'>
            <div class='box box-info'>
                <div class='box-header'>
                    <h3 class='box-title'>Data Penjualan Service </h3>
                    <button class="btn btn-primary my-2 pull-right" data-toggle="modal" data-target="#add-serviskeluar"><i class="fa fa-plus"></i></button>
                                    ...
                                    <?php if ($servis_keluar) : ?>
                                        ...
                                        <?php foreach ($servis_keluar as $serviskeluar) : ?>
                                            <tr>
                                                ...
                                                <td> <?php echo $serviskeluar->id_servis_keluar; ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </tbody>
    ...
    <div class="modal fade add-serviskeluar" id="add-serviskeluar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal fade detail_modal" id="detail_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Servis</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    $('#tambah-serviskeluar').on('submit', function(e) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: '<?php echo base_url('/servis-keluar-store'); ?>',
                    ...
                    $(document).on('click', '.gsearch', function() {
                        ...
                        html +=
                            '<td><input type="text" name="total[]" class="form-control total" value=' + harga + ' required/></td>';
                        html +=
                    ...
                    $(document).on('click', '.detail_penjualan', function() {
                        ...
                        $.ajax({
                            url: "<?php echo base_url('/servis-detail_penjualan'); ?>",
                            method: "POST",
                            data: {
                                id_keluar: id_keluar
                            },
